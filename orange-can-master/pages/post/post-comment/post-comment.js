...
Page({
    ...
    //切换语音和键盘输入
    onSwitchInputTypeTap: function (event) {
        this.setData({
    ...
    // 提交用户评论
    onSubmitCommentTap: function (event) {
    ...
    //选择本地照片与拍照
    onChooseImageTap: function (event) {
        // 已选择图片数组
